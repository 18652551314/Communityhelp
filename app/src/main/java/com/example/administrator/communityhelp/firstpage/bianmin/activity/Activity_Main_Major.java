...
public class Activity_Main_Major extends BaseActivity {

    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private SheQuActivityRecycleViewAdapter recyclerAdapter;
    ...
    public void init() {
        super.init();
        setContentView(R.layout.activity_activity__main__major);
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        textView_back= (TextView) findViewById(R.id.SheQuActivity_back);
        ...
        WebServiceUtils.callWebService(URL, MethodName, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    recyclerAdapter = new SheQuActivityRecycleViewAdapter(listRecycler, Activity_Main_Major.this);
                    recyclerView.setAdapter(recyclerAdapter);
                } else {
                    Toast toast = Toast.makeText(Activity_Main_Major.this, "", Toast.LENGTH_SHORT);
