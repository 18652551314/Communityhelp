package com.example.administrator.communityhelp.firstpage.bianmin.guide;
...
public class Guide_Main_MajorActivity extends BaseActivity {
    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private GuideActivityRecycleViewAdapter recyclerAdapter;
    ...
    public void init() {
        super.init();
        setContentView(R.layout.activity_guide__main__major);
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        textView_back= (TextView) findViewById(R.id.GuideActivity_back);
        ...
        WebServiceUtils.callWebService(URL, MethodName, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    recyclerAdapter = new GuideActivityRecycleViewAdapter(listRecycler, Guide_Main_MajorActivity.this);
                    recyclerView.setAdapter(recyclerAdapter);
                } else {
                    Toast toast = Toast.makeText(Guide_Main_MajorActivity.this, "", Toast.LENGTH_SHORT);
