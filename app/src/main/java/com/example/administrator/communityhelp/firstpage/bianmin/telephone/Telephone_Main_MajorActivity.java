package com.example.administrator.communityhelp.firstpage.bianmin.telephone;
...
import com.example.administrator.communityhelp.myadapter.GuideActivityRecycleViewAdapter;
...
public class Telephone_Main_MajorActivity extends BaseActivity {
    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private TelephoneActivityRecycleViewAdapter recyclerAdapter;
    ...
    public static final String MethodName = "bmInfoList";//方法名
    ...
    public void init() {
        super.init();
        setContentView(R.layout.activity_telephone__main__major);
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        textView_back= (TextView) findViewById(R.id.TelephoneActivity_back);
    ...
    private void GetRequestMessageRecycler() {
        ...
        map.put("pageNo", 0);
        map.put("pageSize", 7);
        map.put("columnId", this.getIntent().getStringExtra("columnId"));
        ...
        WebServiceUtils.callWebService(URL, MethodName, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    recyclerAdapter = new TelephoneActivityRecycleViewAdapter(listRecycler, Telephone_Main_MajorActivity.this);
                    recyclerView.setAdapter(recyclerAdapter);
                } else {
                    Toast toast = Toast.makeText(Telephone_Main_MajorActivity.this, "", Toast.LENGTH_SHORT);
    ...
    public List<Map<String, Object>> jsonPaseRecycler(String result) {
        ...
        try {
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                String colum = jo.getString("colum");
                map.put("id", id);
