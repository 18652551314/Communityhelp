 ...
 */
public class Carpooling_Detaile_Information extends BaseActivity

{
    ...
    public void init() {
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Carpooling_Detaile_Information.this, Forum_Reply.class);
                ...
                switch (event.getAction()){
                    ...
                    case  MotionEvent.ACTION_UP :
                        if (flage == 0) {
                            ...
                            if (item == 0) {
                                Intent intent = new Intent(Carpooling_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Carpooling_Detaile_Information.this.startActivity(intent);
                            } else if (item == 1) {
                                Intent intent = new Intent(Carpooling_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Carpooling_Detaile_Information.this.startActivity(intent);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Carpooling_Detaile_Information.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    new GlideLoader().displayImage(Carpooling_Detaile_Information.this,listRecycler.get(0).get("headimgurl")+"",imageView_touxiang);
                    list_fei.clear();
                    ...
                    if (list_pp.size() == 0) {
                        ...
                        if (point_list2.size()!=0) {
                            ...
                            adapter1 = new Firstpageviewpager(Carpooling_Detaile_Information.this, list_pp);
                    ...
                    Toast.makeText(Carpooling_Detaile_Information.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Carpooling_Detaile_Information.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getData() {
        ...
        for (int i = 0; i < point_list2.size(); i++) {
            ImageView image = new ImageView(this);
            //           image.setScaleType(ImageView.ScaleType.FIT_XY);
            try{new GlideLoader().displayImage(Carpooling_Detaile_Information.this,point_list2.get(i).get("picPath")+"",image);}catch (Exception e){};
