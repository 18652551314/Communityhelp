 ...
 */
public class Housing_Detaile_Information extends BaseActivity {
    ...
    public void init() {
        super.init();
        setContentView(R.layout.housing_detaile_information);
        list = new ArrayList();
        ...
        viewPager = (ViewPager) findViewById(R.id.tv_carpooling_detailed_picture);
        ...
        textView_biaoti = (TextView) findViewById(R.id.title_tv);
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Housing_Detaile_Information.this, Forum_Reply.class);
                ...
                switch (event.getAction()){
                    ...
                    case  MotionEvent.ACTION_UP :
                        if (flage == 0) {
                            ...
                            if (item == 0) {
                                Intent intent = new Intent(Housing_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Housing_Detaile_Information.this.startActivity(intent);
                            } else if (item == 1) {
                                Intent intent = new Intent(Housing_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Housing_Detaile_Information.this.startActivity(intent);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Housing_Detaile_Information.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    new GlideLoader().displayImage(Housing_Detaile_Information.this, listRecycler.get(0).get("headimgurl") + "", imageView_touxiang);
                    ...
                    if (list_pp.size() == 0) {
                        ...
                        if (point_list2.size() != 0) {
                            ...
                            adapter1 = new Firstpageviewpager(Housing_Detaile_Information.this, list_pp);
                    ...
                    Toast.makeText(Housing_Detaile_Information.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Housing_Detaile_Information.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getData() {
        ...
        for (int i = 0; i < point_list2.size(); i++) {
            ImageView image = new ImageView(this);
            //           image.setScaleType(ImageView.ScaleType.FIT_XY);
            try{new GlideLoader().displayImage(Housing_Detaile_Information.this,point_list2.get(i).get("picPath")+"",image);}catch (Exception e){};
