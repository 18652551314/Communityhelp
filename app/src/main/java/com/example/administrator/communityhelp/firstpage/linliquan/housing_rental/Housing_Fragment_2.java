 ...
 */
public class Housing_Fragment_2 extends Fragment {
    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private XunWu_One_ViewAdapter recyclerAdapter;
    ...
    public static final String MethodNameTop = "houseRentalList";//方法名
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerAdapter = new XunWu_One_ViewAdapter(listRecycler, view.getContext());
