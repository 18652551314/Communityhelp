 ...
 */
public class Look_For_Sth_Detaile_Information extends BaseActivity {
    ...
    public void init() {
        super.init();
        setContentView(R.layout.look_for_sth_detaile_information2);
        list = new ArrayList();
        intent_id = getIntent();
        Id = intent_id.getStringExtra("id");
        listView = (ListView) findViewById(R.id.carpooling_details_listview);
        listView.setFocusable(false);
        textView_tit = (TextView) findViewById(R.id.biaoti_look);
        textView_name = (TextView) findViewById(R.id.pinche_tv_name);
        textView_time = (TextView) findViewById(R.id.shijian_look);
        textView_dianhua = (TextView) findViewById(R.id.dianhua_look);
        textView_miaoshu_2 = (TextView) findViewById(R.id.neirong_look);
        viewPager= (ViewPager) findViewById(R.id.tv_look_for_sth_detailed_picture);
        textView_lianxiren = (TextView) findViewById(R.id.lianxiren_look);
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Look_For_Sth_Detaile_Information.this, Forum_Reply.class);
                ...
                switch (event.getAction()){
                    ...
                    case  MotionEvent.ACTION_UP :
                        if (flage == 0) {
                            ...
                            if (item == 0) {
                                Intent intent = new Intent(Look_For_Sth_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Look_For_Sth_Detaile_Information.this.startActivity(intent);
                            } else if (item == 1) {
                                Intent intent = new Intent(Look_For_Sth_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Look_For_Sth_Detaile_Information.this.startActivity(intent);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Look_For_Sth_Detaile_Information.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    new GlideLoader().displayImage(Look_For_Sth_Detaile_Information.this, listRecycler.get(0).get("headimgurl") + "", imageView_touxiang);
                    ...
                    if (list_pp.size() == 0) {
                        ...
                        if (point_list2.size()!=0) {
                            adapter1 = new Firstpageviewpager(Look_For_Sth_Detaile_Information.this, list_pp);
                    ...
                    Toast.makeText(Look_For_Sth_Detaile_Information.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Look_For_Sth_Detaile_Information.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getData() {
        ...
        for (int i = 0; i < point_list2.size(); i++) {
            ImageView image = new ImageView(this);
            //           image.setScaleType(ImageView.ScaleType.FIT_XY);
            try{new GlideLoader().displayImage(Look_For_Sth_Detaile_Information.this,point_list2.get(i).get("picPath")+"",image);}catch (Exception e){};
