package com.example.administrator.communityhelp.firstpage.linliquan.look_for_sth;
 ...
 */
public class Look_For_Sth_Detaile_Information2 extends BaseActivity
{
    ...
    public static final String MethodNameTop = "foundLostContent";//方法名
    ...
    TextView textView_name,textView_time,textView_qidian,textView_con,textView_zhongdian,textView_chufa,textView_lianxiren
            ,textView_dianhua,textView_tit,textView_miaoshu_2,replyNum;
    ...
    public void init() {
        super.init();
        setContentView(R.layout.look_for_sth_detaile_information);
        list = new ArrayList();
        intent_id=getIntent();
        Id=intent_id.getStringExtra("id");
        listView = (ListView) findViewById(R.id.carpooling_details_listview);
        viewPager= (ViewPager) findViewById(R.id.tv_look_for_sth_detailed_picture);
        listView.setFocusable(false);
        textView_tit= (TextView) findViewById(R.id.biaoti_look_2);
        textView_name= (TextView) findViewById(R.id.pinche_tv_name);
        textView_time= (TextView) findViewById(R.id.shijian_look_2);
        textView_dianhua= (TextView) findViewById(R.id.dianhua_look_2);
        textView_miaoshu_2= (TextView) findViewById(R.id.neirong_look_2);
        textView_lianxiren= (TextView) findViewById(R.id.lianxiren_look_2);
        ...
        replyNum= (TextView) findViewById(R.id.tv_look_for_sth_detailed_mess);
        back= (TextView) findViewById(R.id.textview_back_look_for_sth_detailed);
        //返回键
        ...
        //回复信息
        reply= (ImageView) findViewById(R.id.iv_look_for_sth_detailed_mess);
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Look_For_Sth_Detaile_Information2.this, Forum_Reply.class);
                ...
                switch (event.getAction()){
                    ...
                    case  MotionEvent.ACTION_UP :
                        if (flage == 0) {
                            ...
                            if (item == 0) {
                                Intent intent = new Intent(Look_For_Sth_Detaile_Information2.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Look_For_Sth_Detaile_Information2.this.startActivity(intent);
                            } else if (item == 1) {
                                Intent intent = new Intent(Look_For_Sth_Detaile_Information2.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Look_For_Sth_Detaile_Information2.this.startActivity(intent);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Look_For_Sth_Detaile_Information2.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    new GlideLoader().displayImage(Look_For_Sth_Detaile_Information2.this,listRecycler.get(0).get("headimgurl")+"",imageView_touxiang);
                    ...
                    if (list_pp.size() == 0) {
                        ...
                        if (point_list2.size()!=0) {
                            ...
                            adapter1 = new Firstpageviewpager(Look_For_Sth_Detaile_Information2.this, list_pp);
                    ...
                    Toast.makeText(Look_For_Sth_Detaile_Information2.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Look_For_Sth_Detaile_Information2.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getData() {
        ...
        for (int i = 0; i < point_list2.size(); i++) {
            ImageView image = new ImageView(this);
            //           image.setScaleType(ImageView.ScaleType.FIT_XY);
            try{new GlideLoader().displayImage(Look_For_Sth_Detaile_Information2.this,point_list2.get(i).get("picPath")+"",image);}catch (Exception e){};
