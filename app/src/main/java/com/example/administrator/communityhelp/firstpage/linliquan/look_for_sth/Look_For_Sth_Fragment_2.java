 ...
 */
public class Look_For_Sth_Fragment_2 extends Fragment {
    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private Look_For_Sth_Two_ViewAdapter recyclerAdapter;
    ...
    public static final String MethodNameTop = "foundLostList";//方法名
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerAdapter = new Look_For_Sth_Two_ViewAdapter(listRecycler, view.getContext());
