 ...
 */
public class Recruit_Detaile_Information extends BaseActivity {
    ...
    public void init() {
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Recruit_Detaile_Information.this, Forum_Reply.class);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Recruit_Detaile_Information.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    new GlideLoader().displayImage(Recruit_Detaile_Information.this, listRecycler.get(0).get("headimgurl") + "", imageView_touxiang);

                    getdata();

                    //ssnew GlideLoader().displayImage(Forum_Detailed_Information.this,listRecycler.get(0).get("picPath")+"",imageView_tupian);
                } else {
                    Toast.makeText(Recruit_Detaile_Information.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Recruit_Detaile_Information.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
