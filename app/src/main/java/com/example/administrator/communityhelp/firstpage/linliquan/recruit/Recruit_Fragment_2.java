...
import com.example.administrator.communityhelp.myadapter.QiuZhi_Two_ViewAdapter;
 ...
 */
public class Recruit_Fragment_2 extends Fragment {
    private List<Map<String, Object>> listRecycler;
    private RecyclerView recyclerView;
    private QiuZhi_Two_ViewAdapter recyclerAdapter;
    ...
    public static final String MethodNameTop = "searchJobList";//方法名
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerAdapter = new QiuZhi_Two_ViewAdapter(listRecycler, view.getContext());
