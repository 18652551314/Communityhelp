 ...
 */
public class Second_Hand_Detaile_Information extends BaseActivity {
    ...
    public static final String MethodNameTop = "esInfoContent";//方法名
    ...
    TextView textView_name, textView_time, textView_jiage, textView_con, textView_fenlei, textView_chufa, textView_lianxiren, textView_dianhua, textView_tit, textView_miaoshu_2, replyNum;
    ...
    public void init() {
        super.init();
        setContentView(R.layout.second_hand_detaile_information);
        list = new ArrayList();
        ...
        linearLayout = (LinearLayout) findViewById(R.id.linearLayout_carpool);
        textView_tit = (TextView) findViewById(R.id.biaoti_second);
        textView_time = (TextView) findViewById(R.id.shijian_second);
        textView_jiage = (TextView) findViewById(R.id.jiage_second_1);
        textView_fenlei = (TextView) findViewById(R.id.fenlei_second_1);
        textView_lianxiren = (TextView) findViewById(R.id.lianxiren_second_1);
        textView_dianhua = (TextView) findViewById(R.id.dianhua_second_1);
        textView_miaoshu_2 = (TextView) findViewById(R.id.neirong_second_1);
        ...
        back = (TextView) findViewById(R.id.textview_back_second_hand_detailed);
        //返回键
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Second_Hand_Detaile_Information.this, Forum_Reply.class);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (flage == 0) {
                            ...
                            if (item == 0) {
                                Intent intent = new Intent(Second_Hand_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Second_Hand_Detaile_Information.this.startActivity(intent);
                            } else if (item == 1) {
                                Intent intent = new Intent(Second_Hand_Detaile_Information.this, PictureViewPagerActivity2.class);
                                intent.putStringArrayListExtra("path", (ArrayList<String>) list_fei);
                                Second_Hand_Detaile_Information.this.startActivity(intent);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Second_Hand_Detaile_Information.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    textView_jiage.setText(listRecycler.get(0).get("price").toString());
                    textView_fenlei.setText(listRecycler.get(0).get("typeName").toString());
                    //new GlideLoader().displayImage(Second_Hand_Detaile_Information.this,listRecycler.get(0).get("headimgurl")+"",imageView_touxiang);
                    if (list_pp.size() == 0) {
                        getData();
                        if (point_list2.size() != 0) {
                            ...
                            adapter1 = new Firstpageviewpager(Second_Hand_Detaile_Information.this, list_pp);
                    ...
                    Toast.makeText(Second_Hand_Detaile_Information.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                String oldNew = jo.getString("oldNew");
                ...
                try {
                    ...
                    Toast.makeText(Second_Hand_Detaile_Information.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
    ...
    private void getData() {
        ...
        for (int i = 0; i < point_list2.size(); i++) {
            ImageView image = new ImageView(this);
            //           image.setScaleType(ImageView.ScaleType.FIT_XY);
            try{new GlideLoader().displayImage(Second_Hand_Detaile_Information.this,point_list2.get(i).get("picPath")+"",image);}catch (Exception e){};
