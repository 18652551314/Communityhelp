 ...
 */
public class Second_Hand_Detaile_Information2 extends BaseActivity
{
    ...
    TextView textView_name,textView_time,textView_jiage,textView_con,textView_fenlei,textView_chufa,textView_lianxiren
    ...
    public void init() {
        super.init();
        setContentView(R.layout.second_hand_detaile_information2);
        list = new ArrayList();
        ...
        reply.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(Second_Hand_Detaile_Information2.this, Forum_Reply.class);
    ...
    public void getdata() {
        ...
        adapter = new Carpooling_Detaile_Information_Adapter(list, Second_Hand_Detaile_Information2.this);
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    Toast.makeText(Second_Hand_Detaile_Information2.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
...
//            JSONArray array = object.getJSONArray("rows");new JSONObject(result);
            ...
            for (int i = 0; i < array.length(); i++) {
                ...
                try {
                    ...
                    Toast.makeText(Second_Hand_Detaile_Information2.this, "没有图片", Toast.LENGTH_SHORT).show();
                }
