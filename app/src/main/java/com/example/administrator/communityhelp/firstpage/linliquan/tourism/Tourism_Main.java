...
public class Tourism_Main extends BaseActivity {
    TextView textView;
    Intent intent;
    ...
    public static final String MethodNameTop = "lyInfoList";//方法名
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    recyclerAdapter = new LvYou_One_ViewAdapter(listRecycler,Tourism_Main.this);
                    recyclerView.setAdapter(recyclerAdapter);
                } else {
                    Toast.makeText( Tourism_Main.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
