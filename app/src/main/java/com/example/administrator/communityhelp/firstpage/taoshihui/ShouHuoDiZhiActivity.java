        ...
        switch (v.getId()) {
            ...
            case R.id.btn_save:
                if (textView_row.getText().toString().equals("")) {
                    Toast.makeText(ShouHuoDiZhiActivity.this, "请选择街道信息！", Toast.LENGTH_SHORT).show();
                } else if (editText_address.getText().toString().equals("")) {
                    Toast.makeText(ShouHuoDiZhiActivity.this, "请输入详细地址信息！", Toast.LENGTH_SHORT).show();
                } else if (editText_name.getText().toString().equals("")) {
                    Toast.makeText(ShouHuoDiZhiActivity.this, "请输入收货人信息！", Toast.LENGTH_SHORT).show();
                } else if (editText_phone.getText().toString().equals("")) {
                    Toast.makeText(ShouHuoDiZhiActivity.this, "请输入联系电话信息！", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    try {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            if(results.equals("true")){
                                Toast toast = Toast.makeText(ShouHuoDiZhiActivity.this, "", Toast.LENGTH_SHORT);
