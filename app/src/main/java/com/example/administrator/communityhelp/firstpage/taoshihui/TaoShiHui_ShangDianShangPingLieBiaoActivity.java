...
public class TaoShiHui_ShangDianShangPingLieBiaoActivity extends BaseActivity {
    public static final String NameSpace = "http://goods.service.zhidisoft.com";  //命名空间
    public static final String MethodName = "goodsListByMerchant";//方法名
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
    ...
    private void GetRequestMessage() {
        ...
        map.put("pageNo", 0);
        map.put("pageSize", 7);
        map.put("merchantId", this.getIntent().getStringExtra("merchantId"));
        ...
        WebServiceUtils.callWebService(URL, MethodName,NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if(result != null){
                    ...
                    recyclerAdapter = new TaoShiHuiRecycleViewAdapter(listRecycler, TaoShiHui_ShangDianShangPingLieBiaoActivity.this);
                    recyclerView.setAdapter(recyclerAdapter);
                }else{
                    Toast toast = Toast.makeText(TaoShiHui_ShangDianShangPingLieBiaoActivity.this, "", Toast.LENGTH_SHORT);
