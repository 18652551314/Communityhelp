...
public class TaoShiHui_ShangPingLieBiaoActivity extends BaseActivity {
    public static final String NameSpace = "http://goods.service.zhidisoft.com";  //命名空间
    public static final String MethodName = "goodsList";//方法名
    public static final String URL = "http://120.27.5.22:8080/services/goodsService";//地址
    ...
    public void init() {
        super.init();
        setContentView(R.layout.activity_tao_shi_hui__re_mai_tui_jian);
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        textView_back= (TextView) findViewById(R.id.TaoShiHui_backFirstMajor);
    ...
    private void GetRequestMessage() {
        ...
        map.put("pageNo", 0);
        map.put("pageSize", 7);
        map.put("goodsCategoryCode", this.getIntent().getStringExtra("code"));
        map.put("condition", this.getIntent().getStringExtra("condition"));
        ...
        WebServiceUtils.callWebService(URL, MethodName,NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if(result != null){
                    ...
                    listRecycler = jsonPase(json);
                    recyclerAdapter = new TaoShiHuiRecycleViewAdapter(listRecycler, TaoShiHui_ShangPingLieBiaoActivity.this);
                    recyclerView.setAdapter(recyclerAdapter);
                }else{
                    Toast toast = Toast.makeText(TaoShiHui_ShangPingLieBiaoActivity.this, "", Toast.LENGTH_SHORT);
