...
public class TaoShiHui_ShangPingReMaiLieBiaoActivity extends BaseActivity {
    public static final String NameSpace = "http://goods.service.zhidisoft.com";  //命名空间
    public static final String MethodName = "sortGoodsList";//方法名
        ...
        WebServiceUtils.callWebService(URL, MethodName,NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if(result != null){
                    ...
                    recyclerAdapter = new TaoShiHuiRecycleViewAdapter(listRecycler, TaoShiHui_ShangPingReMaiLieBiaoActivity.this);
                    recyclerView.setAdapter(recyclerAdapter);
                }else{
                    Toast toast = Toast.makeText(TaoShiHui_ShangPingReMaiLieBiaoActivity.this, "", Toast.LENGTH_SHORT);
