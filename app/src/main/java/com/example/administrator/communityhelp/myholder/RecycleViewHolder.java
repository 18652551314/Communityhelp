...
public class RecycleViewHolder extends RecyclerView.ViewHolder{
    ...
    public TextView textView_name,textView_referral,textView_price,textView_oldPrice,textView_sold;
    public RecycleViewHolder(View itemView) {
        ...
        textView_sold= (TextView) itemView.findViewById(R.id.textView_sold);
    }
}
