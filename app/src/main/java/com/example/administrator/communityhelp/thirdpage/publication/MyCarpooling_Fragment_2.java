 ...
 */
public class MyCarpooling_Fragment_2 extends Fragment implements MyCallBack {
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(3,StaggeredGridLayoutManager.VERTICAL));
        ...
        WebServiceUtils.callWebService(URL, MethodNameTop, NameSpace, map, new WebServiceUtils.WebServiceCallBack() {
            ...
            public void callBack(SoapObject result) {
                ...
                if (result != null) {
                    ...
                    recyclerAdapter.setMyCallBack2(MyCarpooling_Fragment_2.this);
                    recyclerView.setAdapter(recyclerAdapter);
                } else {
    ...
    public List<Map<String, Object>> jsonPaseTop(String result) {
        ...
        try {
            Gson gson = new Gson();
            MyCarpooling_Fragment_1.myCarpooling myCarpool = gson.fromJson(result, MyCarpooling_Fragment_1.myCarpooling.class);
