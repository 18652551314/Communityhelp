 ...
 */
public class MyHousing_Fragment_1 extends Fragment {
...
//                    Log.e("json", "json: " + json);
    ...
    public List<Map<String, Object>> jsonPaseTop(String result) {
        ...
        try {
            Gson gson = new Gson();
            MyHouseRental myHouseRental = gson.fromJson(result, MyHouseRental.class);
    ...
    public class MyHouseRental {

        /**
         * total : 1
         * pageNo : 1
         * curTime : 1443255055191
         * pageSize : 20
         * rows : [{"createTime":"2015-01-06 11:50:18","approve":true,"contactPhone":"13733653356","infoType":"cz","contact":"李进","replyNum":0,"id":"fdaeb2454abcb243014abd5d554c00e3","content":"价格 1400 元/月 　押一付三　\n概况 1室 0厅 1卫    商住两","picPath":"http://192.168.1.110:9999/upl115138139_thumbnail","title":"文化路东风路交叉口房屋出租","start":"","userName":"嘿嘿","headimgurl":"http://192.168.1.110:9999/uploadFiles/069/20150106111255797","end":"","approvedResult":1}]
         */
        ...
        public class RowsBean {
            /**
             * createTime : 2015-01-06 11:50:18
             * approve : true
             * contactPhone : 13733653356
             * infoType : cz
             * contact : 李进
             * replyNum : 0
             * id : fdaeb2454abcb243014abd5d554c00e3
             * content : 价格 1400 元/月 　押一付三
             * 概况 1室 0厅 1卫    商住两
             * picPath : http://192.168.1.110:9999/upl115138139_thumbnail
             * title : 文化路东风路交叉口房屋出租
             * start :
             * userName : 嘿嘿
             * headimgurl : http://192.168.1.110:9999/uploadFiles/069/20150106111255797
             * end :
             * approvedResult : 1
             */
