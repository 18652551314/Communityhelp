...
import com.example.administrator.communityhelp.myadapter.Look_For_Sth_One_ViewAdapter;
 ...
 */
public class MyLook_For_Sth_Fragment_1 extends Fragment {
    ...
    private Look_For_Sth_One_ViewAdapter recyclerAdapter;
    ...
    public static final String MethodNameTop = "myFoundLostList";//方法名
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerAdapter = new Look_For_Sth_One_ViewAdapter(listRecycler, view.getContext());
            ...
            public void getintent(LinearLayout linearLayout, ImageView imageView) {
                linearLayout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(view.getContext(), Look_For_Sth_Detaile_Information.class);
    ...
    private void begainRefresh() {
        new Thread(new Runnable() {
            ...
            public void run() {
                while (true) {
                    try {
                        MyLook_For_Sth_Main activity = (MyLook_For_Sth_Main) getActivity();
                        if (activity.startDeletecode == 1) {
                            while (true) {
                                activity = (MyLook_For_Sth_Main) getActivity();
...
//                    Log.e("json", "json: " + json);
    ...
    public List<Map<String, Object>> jsonPaseTop(String result) {
        ...
        try {
            Gson gson = new Gson();
            MyFoundLost myFoundLost = gson.fromJson(result, MyFoundLost.class);
            int total = myFoundLost.getTotal();
            this.total = total;
            for (int i = 0; i < total; i++) {
                Map<String, Object> map = new HashMap<>();
                map.put("total", total);

                String userName = myFoundLost.getRows().get(i).getUserName();
                String createTime = myFoundLost.getRows().get(i).getCreateTime();
                String content = myFoundLost.getRows().get(i).getContent();
                String headimgurl = myFoundLost.getRows().get(i).getHeadimgurl();
                String contact = myFoundLost.getRows().get(i).getContact();
                String contactPhone = myFoundLost.getRows().get(i).getContactPhone();
                int replyNum = myFoundLost.getRows().get(i).getReplyNum();
                String title = myFoundLost.getRows().get(i).getTitle();
                String id = myFoundLost.getRows().get(i).getId();
                int approvedResult = myFoundLost.getRows().get(i).getApprovedResult();
                String picPath=myFoundLost.getRows().get(i).getPicPath();
    ...
    public class MyFoundLost {

        /**
         * total : 1
         * pageNo : 1
         * curTime : 1443253697077
         * pageSize : 10
         * rows : [{"createTime":"2015-01-05 13:38:47","approve":true,"contactPhone":"13213762772","infoType":"xw","contact":"武先生","replyNum":0,"id":"fdaeb2454ab426a2014ab89a4ba000ff","content":"2014.12.27号晚大概6:30在经八路段或纬三路段丢失黑色","picPath":"","title":"寻黑色钱包中身份证、银行卡等，定重谢","start":"","userName":"小雪","headimgurl":"http://192.168.1.110:9999/upl0150106094504639","end":"","approvedResult":1}]
         */
        ...
        public class RowsBean {
            /**
             * createTime : 2015-01-05 13:38:47
             * approve : true
             * contactPhone : 13213762772
             * infoType : xw
             * contact : 武先生
             * replyNum : 0
             * id : fdaeb2454ab426a2014ab89a4ba000ff
             * content : 2014.12.27号晚大概6:30在经八路段或纬三路段丢失黑色
             * picPath :
             * title : 寻黑色钱包中身份证、银行卡等，定重谢
             * start :
             * userName : 小雪
             * headimgurl : http://192.168.1.110:9999/upl0150106094504639
             * end :
             * approvedResult : 1
             */
