...
import com.example.administrator.communityhelp.firstpage.linliquan.look_for_sth.Look_For_Sth_Details_Main_1;
import com.example.administrator.communityhelp.firstpage.linliquan.look_for_sth.Look_For_Sth_Fragment_1;
import com.example.administrator.communityhelp.firstpage.linliquan.look_for_sth.Look_For_Sth_Fragment_2;
 ...
 */
public class MyLook_For_Sth_Main extends BaseActivity implements MyCallBack ,View.OnClickListener{
    ...
    public void init() {
        ...
        textView1.setText("寻物招领");
        textView2.setText("寻物");
    ...
    public void iv_suppor_1(View v) {
        if (isLoad()) {
            if (position1 == 0) {
                intent = new Intent(this, Look_For_Sth_Details_Main.class);
                startActivity(intent);
            } else {
                intent = new Intent(this, Look_For_Sth_Details_Main_1.class);
                startActivity(intent);
            }
        } else {
    ...
    private void instart() {
        list = new ArrayList<>();
        list.add(new MyLook_For_Sth_Fragment_1());
        list.add(new MyLook_For_Sth_Fragment_2());
    }
    ...
    private void startDelete() {
       ...
       progress.show();
        ...
        final WebSerVieceUtil web = new WebSerVieceUtil("http://info.service.zhidisoft.com", "foundLostRemove", "infoExchangeService", map);
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MyLook_For_Sth_Main.this, "删除失败", Toast.LENGTH_SHORT).show();
                            isdeleting = false;
                            return;
                        }
                    });
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(MyLook_For_Sth_Main.this, "删除成功", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        }).start();
