 ...
 */
public class MyRecruit_Fragment_2 extends Fragment {
...
//        Log.e("json", "result: " + result);
        try {
            Gson gson = new Gson();
            MyRecruit_Fragment_1.myJobpublic myJobpub = gson.fromJson(result, MyRecruit_Fragment_1.myJobpublic.class);
